...
urlpatterns = [
    ...
    path("article/<int:pk>/delete/", NewspaperDeleteView.as_view(), name="newspaper-delete"),
    path("article/<int:pk>/detail", NewspaperDetailView.as_view(), name="newspaper-detail"),
    path("article/create/", NewspaperCreateView.as_view(), name="newspaper-create"),
    path("article/<int:pk>/update/", NewspaperUpdateView.as_view(), name="newspaper-update"),
    ...
    path("topics/<int:pk>/detail/", TopicDetailView.as_view(), name="topic-detail"),
]
