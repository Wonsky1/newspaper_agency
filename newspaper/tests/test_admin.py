...
class AdminSiteTests(TestCase):
    NEWSPAPER_CHANGE_LIST_URL = "admin:newspaper_newspaper_changelist"
    REDACTOR_CHANGE_URL = "admin:newspaper_redactor_change"
    ...
    def test_redactor_admin_page(self):
        response = self.client.get(
            reverse(self.NEWSPAPER_CHANGE_LIST_URL)
        )
    ...
    def test_topic_admin_page(self):
        url = reverse(self.NEWSPAPER_CHANGE_LIST_URL)
